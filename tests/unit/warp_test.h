...
namespace onebit
{
    namespace test
    {
            ...
            int iterations = 1)
        {
            ...
            __shared__ cutlass::Array<typename Mma::ElementA,
                                      ThreadblockShape::kM *
                                          ThreadblockShape::kK / Mma::kSparse>
                smem_buffer_A;

            __shared__ cutlass::Array<
...
#pragma unroll 1
            ...
            typename Mma::TransformedFragmentA tfrag_A;
            typename Mma::TransformedFragmentB tfrag_B;
            ...
            { // place in loop that is not unrolled
                     ...
                     k += Mma::Policy::MmaShape::kK)
                {
                    iter_A.load(frag_A);
                    iter_B.load(frag_B);
                    mma.transform(tfrag_A, tfrag_B, frag_A, frag_B);
                    ...
                    mma(accum, tfrag_A, tfrag_B, accum, frag_E);
                }
            }
